...
![Запрос для круговой диаграммы](screen/3.png) ![](screen/4.png)

2\. Представить в виде столбчатой диаграммы соотношение входящего и
исходящего трафика из внутреннего сетвого сегмента.

![Запрос для столбчатой диграммы](screen/5.png) ![](screen/6.png)

3\. Построить график активности (линейная диаграмма) объема трафика во
времени.

<figure>
<img src="screen/7.png" alt="Запрос для линейной диграммы" />
<figcaption aria-hidden="true">Запрос для линейной диграммы</figcaption>
</figure>
...
[Дашборд мониторинга сетевой
активности](https://datalens.ru/bvpwwjl09kn6v)
